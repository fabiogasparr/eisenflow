...
export async function getRateLimitEvents(
  ...
  try {
    ...
    // A tabela é snake_case; o contrato desta função é camelCase. Sem este
    // mapa o tsc já apontava o descompasso — o erro só ficava escondido atrás
    // de um erro de sintaxe em outro arquivo.
    return (data || []).map((e) => ({
